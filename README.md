...
The `docs/` directory contains Jupyter notebooks used during development:

- `L4.ipynb` — MCP client basics
- `L5.ipynb` — Tool calling patterns
- `L6.ipynb` — Advanced orchestration
- `mcp_chatbot.py` — Standalone script version of the chatbot
- `walkthrough.md` — Step-by-step build walkthrough
